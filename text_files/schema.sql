...
('Scientology', 'a religion founded by L. Ron Hubbard that is characterized by its emphasis on self-improvement and spiritual growth through the use of counseling and self-help techniques.', 'United States', 'Beliefs vary widely among individual practitioners, but often include the concept of the thetan, past lives, and the reactive mind.', 'Practices include auditing, which is a form of spiritual counseling, and various courses and training programs.'),
('Wicca', 'a modern, nature-based religion that is characterized by its worship of a goddess and god, and its emphasis on magic and ritual.', 'United Kingdom', 'Beliefs vary widely among individual practitioners, but often include the concept of the God and Goddess, the cycles of nature, and magic.', 'Practices include rituals, spells, and celebrations based on the cycles of the moon and the seasons.');
